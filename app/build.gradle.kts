...
dependencies {
    implementation(libs.spring.boot.starter.webmvc.common)
    implementation(libs.spring.boot.starter.actuator.common)
    implementation(libs.spring.boot.starter.data.jpa.common)
    implementation(libs.spring.boot.starter.validation.common)
    implementation(libs.spring.boot.starter.flyway.common)
    implementation(libs.spring.boot.starter.security.oauth2.resource.server.common)
