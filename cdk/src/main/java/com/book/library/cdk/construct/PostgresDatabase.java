...
public class PostgresDatabase extends Construct {
    ...
    public PostgresDatabase(
        ...
        Network.NetworkOutputParameters networkOutputParameters =
                Network.getOutputParametersFromParameterStore(this, applicationEnvironment);
    ...
    private static String getEndpointAddress(Construct scope, ApplicationEnvironment environment) {
        return StringParameter.fromStringParameterName(
                        scope, PARAMETER_ENDPOINT_ADDRESS, createParameterName(environment, PARAMETER_ENDPOINT_ADDRESS))
                .getStringValue();
    }

    private static String getEndpointPort(Construct scope, ApplicationEnvironment environment) {
        return StringParameter.fromStringParameterName(
                        scope, PARAMETER_ENDPOINT_PORT, createParameterName(environment, PARAMETER_ENDPOINT_PORT))
                .getStringValue();
    }

    private static String getDbName(Construct scope, ApplicationEnvironment environment) {
        return StringParameter.fromStringParameterName(
                        scope, PARAMETER_DATABASE_NAME, createParameterName(environment, PARAMETER_DATABASE_NAME))
                .getStringValue();
    }
    ...
    private void createOutputParameters() {
        ...
        StringParameter.Builder.create(this, PARAMETER_ENDPOINT_ADDRESS)
        ...
        StringParameter.Builder.create(this, PARAMETER_ENDPOINT_PORT)
        ...
        StringParameter.Builder.create(this, PARAMETER_DATABASE_NAME)
        ...
        StringParameter.Builder.create(this, PARAMETER_INSTANCE_ID)
